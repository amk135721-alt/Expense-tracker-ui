     ...
     <Box sx={{backgroundColor:"black"}} >
        ...
        onChange={(e)=>setformdata({...formdata,category:e.target.value})}
          ...
          <MenuItem value={"Other"}>Other</MenuItem>
                ...
                <Button  onClick={handlesubmit} sx={{mb:1}} color="secondary" 
                loading={isloading}
                variant="contained"  fullWidth>SUBMIT</Button>
                <Button component={Link} to={"/"} sx={{mb:1,backgroundColor:"white"}} color="secondary" 
                variant="outlined"  fullWidth>VIEW ENTRIES</Button>
                <Button sx={{mb:1,backgroundColor:"white"}} color="secondary" 
                variant="outlined"  fullWidth>CLEAR ENTRIES</Button>
            </Paper>
        </Box>
     </Box>
    </div>
